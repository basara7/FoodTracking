...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/LLBootstrapButton.framework"
  install_framework "Pods/MBProgressHUD.framework"
  install_framework "Pods/MJRefresh.framework"
  install_framework "Pods/NHArrowView.framework"
  install_framework "Pods/OMGHTTPURLRQ.framework"
  install_framework "Pods/PPiAwesomeButton.framework"
  install_framework "Pods/PPiFlatSegmentedControl.framework"
  ...
  install_framework "Pods/UIView_FrameEx.framework"
  install_framework "Pods/ZZPopoverWindow.framework"
